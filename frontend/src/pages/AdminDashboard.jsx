    ...
    if (user?.role !== 'admin') {
        return (
            <div className="container" style={{ padding: '5rem', textAlign: 'center', minHeight: '60vh', display: 'flex', flexDirection: 'column', justifyContent: 'center', alignItems: 'center' }}>
                ...
                <h2 style={{ fontSize: '2rem', fontWeight: 'bold' }}>Accès Refusé</h2>
    ...
    return (
        <div style={{ display: 'flex', minHeight: 'calc(100vh - 64px)', background: '#f9fafb' }}>
            ...
            <main style={{ flex: 1, padding: '2rem 3rem', overflowY: 'auto' }}>
                ...
                {activeTab === 'overview' && (
                    <div className="fade-in">
                        ...
                        {loading ? <p>Chargement des statistiques...</p> : (
                            <>
                                <h3 style={{ fontSize: '1.25rem', fontWeight: 'bold', marginBottom: '1rem', color: '#374151' }}>Réclamations</h3>
                                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(200px, 1fr))', gap: '1.5rem', marginBottom: '3rem' }}>
                                    ...
                                    <div className="card" style={{ padding: '1.5rem', display: 'flex', alignItems: 'center', gap: '1.5rem' }}>
                                        ...
                                        <div><h3 style={{ fontSize: '1.75rem', fontWeight: 'bold' }}>{stats.complaints_resolved}</h3><p style={{ color: '#6b7280' }}>Résolues</p></div>
                                    </div>
                                </div>
                ...
                {activeTab === 'complaints' && (
                    <div className="fade-in">
                        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '2rem' }}>
                            <h1 style={{ fontSize: '2rem', fontWeight: 'bold' }}>Gestion des Réclamations</h1>
                        ...
                        <div className="card" style={{ overflowX: 'auto', background: 'white' }}>
                            <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'left' }}>
                                <thead style={{ background: '#f9fafb', borderBottom: '1px solid var(--border)' }}>
                                    <tr>
                                        <th style={{ padding: '1rem 1.5rem', color: '#4b5563', fontWeight: '600' }}>Réclamation</th>
                                        <th style={{ padding: '1rem 1.5rem', color: '#4b5563', fontWeight: '600' }}>Citoyen</th>
                                        <th style={{ padding: '1rem 1.5rem', color: '#4b5563', fontWeight: '600' }}>Catégorie</th>
                                ...
                                <tbody>
                                    {loading ? (
                                        ...
                                        <tr><td colSpan="5" style={{ padding: '3rem', textAlign: 'center', color: '#6b7280' }}>Aucune réclamation trouvée.</td></tr>
                            ...
                            <table style={{ width: '100%', borderCollapse: 'collapse', textAlign: 'left' }}>
                                <thead style={{ background: '#f9fafb', borderBottom: '1px solid var(--border)' }}>
                                    <tr>
                                        ...
                                        <th style={{ padding: '1rem 1.5rem', color: '#4b5563', fontWeight: '600' }}>Email & Tél</th>
                                        <th style={{ padding: '1rem 1.5rem', color: '#4b5563', fontWeight: '600' }}>Rôle</th>
                                        <th style={{ padding: '1rem 1.5rem', color: '#4b5563', fontWeight: '600' }}>Actions</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    {loading ? (
                                        ...
                                        <tr><td colSpan="4" style={{ padding: '3rem', textAlign: 'center', color: '#6b7280' }}>Aucun utilisateur trouvé.</td></tr>
                                    ) : usersList.map(u => (
                                        <tr key={u.id} style={{ borderBottom: '1px solid var(--border)' }}>
                                            ...
                                            <td style={{ padding: '1rem 1.5rem' }}>
                                                ...
                                                <div style={{ fontSize: '0.875rem', color: '#6b7280' }}>{u.phone || 'Non renseigné'}</div>
                                            </td>
                                            <td style={{ padding: '1rem 1.5rem' }}>
                                                <select
                                                    value={u.role}
                ...
                {activeTab === 'settings' && (
                    <div className="fade-in">
                        <h1 style={{ fontSize: '2rem', fontWeight: 'bold', marginBottom: '2rem' }}>Paramètres de la Plateforme</h1>
                        <div className="card" style={{ padding: '3rem', textAlign: 'center', color: '#6b7280' }}>
                            ...
                            <h3 style={{ fontSize: '1.25rem', fontWeight: '600', color: '#374151', marginBottom: '0.5rem' }}>Paramètres à venir</h3>
                            <p>Les paramètres globaux du contenu et de la plateforme seront disponibles dans une prochaine mise à jour.</p>
                        </div>
                    </div>
                )}
            </main>
