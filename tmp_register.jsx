        ...
        <div style={{ minHeight: '80vh', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '4rem 0' }}>
            <div className="card" style={{ width: '100%', maxWidth: '600px', padding: '2.5rem' }}>
                <div style={{ textAlign: 'center', marginBottom: '2rem' }}>
                    <h2 style={{ fontSize: '1.75rem', fontWeight: 'bold', color: '#1e3c72' }}>Cr├®er un compte</h2>
                    <p style={{ color: '#ff8c42', marginTop: '0.5rem' }}>Rejoignez notre communaut├® citoyenne</p>
                </div>
                ...
                <form onSubmit={handleSubmit} style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1.25rem' }}>
                    <div style={inputGroupStyle}>
                        <label style={{ fontSize: '0.875rem', fontWeight: '500' }}>Pr├®nom</label>
                        <div style={{ position: 'relative' }}>
                            <User size={18} style={iconStyle} />
                            <input name="first_name" value={formData.first_name} onChange={handleChange} required placeholder="votre pr├®nom" style={inputStyle} />
                        </div>
                    ...
                    <div style={inputGroupStyle}>
                        <label style={{ fontSize: '0.875rem', fontWeight: '500' }}>T├®l├®phone</label>
                        <div style={{ position: 'relative' }}>
                    ...
                    <div style={inputGroupStyle}>
                        ...
                        <div style={{ position: 'relative' }}>
                            ...
                            <input type="password" name="password" value={formData.password} onChange={handleChange} required placeholder="ÔÇóÔÇóÔÇóÔÇóÔÇóÔÇóÔÇóÔÇó" style={inputStyle} />
                        </div>
                    ...
                    <div style={inputGroupStyle}>
                        ...
                        <div style={{ position: 'relative' }}>
                            <Lock size={18} style={iconStyle} />
                            <input type="password" name="password_confirmation" value={formData.password_confirmation} onChange={handleChange} required placeholder="ÔÇóÔÇóÔÇóÔÇóÔÇóÔÇóÔÇóÔÇó" style={inputStyle} />
                        </div>
                    </div>
                ...
                <p style={{ textAlign: 'center', marginTop: '1.5rem', fontSize: '0.875rem', color: '#1e3c72' }}>
                    D├®j├á un compte ? <Link to="/login" style={{ color: '#ff8c42', fontWeight: '600' }}>Se connecter</Link>
                </p>
            </div>
        </div>
    );
